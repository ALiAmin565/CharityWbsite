                    ...
                    <table id="example" class="table key-buttons text-md-nowrap" data-page-length='50' style="text-align: center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="">
                                        {{-- "{{ url('InvoicesDetails') }}/{{ $invoice->id }}" --}}
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu tx-13">
                                            ...
                                            <a class="dropdown-item" href="">تعديل الفاتورة</a>



                                            <a class="dropdown-item" href="#" data-invoice_id="id" data-file_name="invoice_number" data-toggle="modal" data-target="#delete_invoice"><i class="text-danger fas fa-trash-alt"></i>&nbsp;&nbsp;حذف الفاتورة</a>



                                            <a class="dropdown-item" href="invoices show"><i class=" text-success fas fa-money-bill"></i>&nbsp;&nbsp;تغير حالة الدفع</a>



                                            <a class="dropdown-item" href="#" data-invoice_id="id" data-toggle="modal" data-target="#Transfer_invoice"><i class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;نقل الي الارشيف</a>

                                            <a class="dropdown-item" href="Print_invoice/id"><i class="text-success fas fa-print"></i>&nbsp;&nbsp;طباعة الفاتورة</a>
