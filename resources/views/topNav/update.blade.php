...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> القائمة العلوية</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"> /
                    تعديل القائمة العلوية </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form id="myForm" action="{{ route('topnav.update', $topNav->id) }}" method="post"
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputTwitter" value="{{ $topNav->twitter }}"
                                    name="twitter" placeholder="يرجي ادخال الرابط ">
                            </div>
                            <div class="col">
