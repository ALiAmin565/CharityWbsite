                        ...
                        <table id="example" class="table key-buttons text-md-nowrap" data-page-length='50'
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0"> العنوان الاول </th>
                                    <th class="border-bottom-0"> العنوان الاول </th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('imagesfb/'.$section->image) }}" alt="" width="100px" height="100px">
                                    </td>
                                    <td>
                                        {{ $section->titleOne }}
                                    </td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                <a class="dropdown-item"
                                                    href="{{ route('sectionleft.edit', $section->id) }}">تعديل </a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
