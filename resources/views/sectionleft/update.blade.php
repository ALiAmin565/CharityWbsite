...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> محتوي القسم الثاني </h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0"> /
                    تعديل القسم الثاني </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body" style="text-align:center">
                    <form id="myForm" action="{{ route('sectionleft.update', $section->id) }}" method="post"
